...
class ContainerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatMethod()
    {
        ...
        $stub = new Container(new Environment($request), $template, array(), null);
    ...
    public function testRenderMethod()
    {
        ...
        $stub = new Container(new Environment($request), $template, array());
    ...
    public function testToStringMethod()
    {
        ...
        $stub1 = new Container(new Environment($request), $template1, array(), 'json');
        ...
        $stub2 = new Container(new Environment($request), $template2, array(), 'json');
